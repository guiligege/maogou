...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <!-- Le styles -->
    <link href="${domain_css}/css/bootstrap.css" rel="stylesheet"></link>
    <style type="text/css">
      body {
        padding-top: 60px;
        padding-bottom: 40px;
    ...
    <link href="${domain_css}/css/bootstrap-responsive.css" rel="stylesheet"></link>
    <script src="${domain_js}/js/jquery.js"></script>
    ...
    <!-- Fav and touch icons -->
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="${domain_image}/ico/apple-touch-icon-144-precomposed.png"></link>
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="${domain_image}/ico/apple-touch-icon-114-precomposed.png"></link>
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="${domain_image}/ico/apple-touch-icon-72-precomposed.png"></link>
    <link rel="apple-touch-icon-precomposed" href="${domain_image}/ico/apple-touch-icon-57-precomposed.png"></link>
    <link rel="shortcut icon" href="${domain_image}/ico/favicon.png"></link>
  ...
  <body>
    ...
    <script src="${domain_js}/js/bootstrap-transition.js?${version_js}"></script>
    <script src="${domain_js}/js/bootstrap-alert.js?${version_js}"></script>
    <script src="${domain_js}/js/bootstrap-modal.js?${version_js}"></script>
    <script src="${domain_js}/js/bootstrap-dropdown.js?${version_js}"></script>
    <script src="${domain_js}/js/bootstrap-scrollspy.js?${version_js}"></script>
    <script src="${domain_js}/js/bootstrap-tab.js?${version_js}"></script>
    <script src="${domain_js}/js/bootstrap-tooltip.js?${version_js}"></script>
    <script src="${domain_js}/js/bootstrap-popover.js?${version_js}"></script>
    <script src="${domain_js}/js/bootstrap-button.js?${version_js}"></script>
    <script src="${domain_js}/js/bootstrap-collapse.js?${version_js}"></script>
    <script src="${domain_js}/js/bootstrap-carousel.js?${version_js}"></script>
    <script src="${domain_js}/js/bootstrap-typeahead.js?${version_js}"></script>
