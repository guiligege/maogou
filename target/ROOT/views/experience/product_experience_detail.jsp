...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<!-- seo信息 -->
		<title>${shoppingExperience.title}-我买么
		</title>
		<!--start seo -->
		...
		<c:if test="${empty seokeywords}">
			<meta name="keywords" content="${shoppingExperience.title},${shoppingExperience.title}购物经验，${shoppingExperience.title}经验分享"/>
		</c:if>
	...
	<body>
		<div class="wrapper">
		    ...
		    <div class="section_container">
		        <div class="section">
		           <jsp:include page="product_experience_detail_content.jsp"></jsp:include>
		        </div>
		    </div>
