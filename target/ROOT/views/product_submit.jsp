		    ...
		    <div class="section_container" style="width:980px;margin:0px auto;">
		        <section>
		            <div id="banner_section" class="content">
		                <div class="left_main">
		                <form data-action="${pageContext.request.contextPath}/product/saveShare.htm" method="post" id="saveform" action="${pageContext.request.contextPath}/product/saveShare.htm">
